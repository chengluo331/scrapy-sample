...
class PassportnotifierPipeline(object):
    def __init__(self):
        self.data = {'result': {u'./t1203113.htm': u'(2014-10-23)',
  ...
  u'./t765259.htm': u'(2014-07-29)'}}
        self.mailer = MailSender(smtphost=os.environ['smtphost'],
    ...
    def process_item(self, item, spider):
        if item != self.data:
            logger.info("page updated! sending email ...")
            self.mailer.send(to=[os.environ['mailto']], subject="passport updated", body="please take a look")
        else:
